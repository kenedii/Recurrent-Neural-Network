// This file is the same as RNN.c with removed __declspec(dllexport) for Linux compatibility
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
#include <string.h>
...
float train(params *p, float *embedded_X, int *targets, int sequence_length, int embedding_dim, int epochs, float learning_rate, float *d_embedded_X)
{
    // Allocate memory
...
float *generate(params *p, float *embeddings, int vocab_size, int start_idx, int eos_idx, int max_len, int *gen_len)
{
